...
4.  Build the Power BI dashboard — Turn the SQL analysis into an interactive dashboard: KPI cards, a failures-by-part bar chart, a failures-over-time line chart, a       top-5-root-causes table, and slicers to filter by machine or technician.
...
What I did
Created a database and a raw staging table.
Loaded the CSV using MySQL's bulk import.
Ran baseline checks (row count, duplicate IDs, distinct values in messy columns).
